...
%
%
function [channelPrefs, channelTuning, chanFit, r2val] = fitCinvorForwardModel(instancesTrain,trainStimVals,instancesTest,testStimVals,e,varargin)
dispFig = 0;
% get arguments
...
if zs
  channel=buildChannels(instancesTrain,trainStimVals,'dispChannels=0','zscore=1');
else
  channel=buildChannels(instancesTrain,trainStimVals,'dispChannels=0');
end
...
rangeScaleFac=360/e.totalRangeDeg;
chanFit=fitTuningWithVM(channelTuning, channelPrefs,rangeScaleFac,0);
chanFit=chanFit(1,:);
r2val=r2.overall;
