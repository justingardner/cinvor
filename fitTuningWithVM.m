...
if(fixedMean)
  [paramFit1,resnorm,residual,exitflag]=lsqcurvefit(@vonMises,paramInit,d2r(channelPref(1:M)*rangeScaleFac),chanResp(1,1:M),[pi-0.01,0,0,0],[pi+0.01,1000,1000,1000]);
  [paramFit2,resnorm,residual,exitflag]=lsqcurvefit(@vonMises,paramInit,d2r(channelPref(1:M)*rangeScaleFac),chanResp(2,1:M),[pi-0.01,0,0,0],[pi+0.01,1000,1000,1000]);
else
  [paramFit1,resnorm,residual,exitflag]=lsqcurvefit(@vonMises,paramInit,d2r(channelPref(1:M)*rangeScaleFac),chanResp(1,1:M));
  [paramFit2,resnorm,residual,exitflag]=lsqcurvefit(@vonMises,paramInit,d2r(channelPref(1:M)*rangeScaleFac),chanResp(2,1:M));
end
